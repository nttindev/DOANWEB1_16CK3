...
<body>      
	<div class="form_i">
		<form action="index.php?b=exDangKy" class="frmdangky" align="center" method="POST">
	...
	<span class="spngaysinh">Ngày sinh</span><select name="ngay" id="" class="ngaysinh">
		...
		<span class="spbansongtai">Bạn sống tại</span> <select name="thanhpho"  class="noisinh">
						...
						<option value="Hồ Chí Minh">Hồ Chí Minh</option>
			             ...
			             <option value="Bình Định">Bình Phước</option>
 ...
 <h2 class="h2">Thông tin tài khoản</h2>
            ...
            <progress max="100" value="0" id="strength" style="width: 230px;" class="do-manh"></progress>
