<div class="boc-ngoai">
 	  	<div class="trai">
			 ...
			 foreach($lstGioHang as $gioHangBUS)
			 {
 	  		 ...
 	  		 ?>
 	  			...
 	  			<div class="gia-sp"><p class="p-gia"><?php echo number_format($soluong*$gia); ?></p></div>
 	  		...
 	  		<!-- <div class="mat-hang">
 	  			<div class="san-pham-thanh-toan">
 	  				 <img src="GUI/images/3.jpg" alt="" class="img-tt">
 	  				 <p class="p-ten"> HUAWEI MEDIA PAD PRO T310</p>
 	  				  <div class="hang-san-xuat"><p class="hang">OPPO</p></div>
 	  			</div>
 	  			<div class="gia-sp"><p class="p-gia">40,000,000</p></div>
 	  	...
 	  	<div class="phai">
 	  		...
 	  		<div class="thong-tin-don-hang">
 	  			...
 	  			<p class="p-tong-tien">'.number_format($tong).'</p>
 	  		</div>
 	  		<div class="tam-tinh"></div>
 	  		<div class="nut-thanh-toan"><a href="" class="thanh-toan">Thanh Toán</a></div>';
